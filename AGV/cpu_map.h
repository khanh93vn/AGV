...
#define IO_STEER_P  9   // Chân cấp PWM cho động cơ lái
#define IO_STEER_H1 10  // Chân cấp cầu H động cơ lái
#define IO_STEER_H2 11  // Chân cấp cầu H động cơ lái
...
#define INT_IMU     2   // Chân ngắt nối với cảm biến MPU6050
